  ...
  const projects = [
    {
      ...
      icon: CheckCircle,
      description: 'Revolutionary AI-powered system for comprehensive employee performance auditing, skill gap analysis, and productivity optimization.',
      features: [
      ...
      image: 'https://images.unsplash.com/photo-1551434678-e076c2238f2a?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80'
    },
    {
      title: 'Smart Public Procurement System',
      icon: Shield,
      description: 'Blockchain-enabled transparent procurement platform that eliminates fraud, ensures compliance, and optimizes government spending.',
      features: [
    ...
    },
    {
      ...
      icon: Eye,
      description: 'Immersive Extended Reality (XR) training simulations for hazardous environment preparation and safety protocol mastery.',
      features: [
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="py-16">
        <div className="container-custom">
          {projects.map((project, index) => (
            <div key={index} className={`mb-20 last:mb-0 ${index % 2 === 1 ? 'md:flex-row-reverse' : ''} md:flex gap-12 items-center`}>
      ...
      <section className="bg-gray-50 py-16">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bold mb-4">Interested in These Solutions?</h2>
          <p className="text-xl text-gray-600 mb-8">
            Contact us to discuss how we can implement similar solutions for your organization
          </p>
          <a 
            href="/contact" 
