...
import { Calendar, Clock, MapPin, Users, Award, Code, Shield, Wifi, TrendingUp } from 'lucide-react'
  ...
  const events = [
    {
      ...
      description: 'Official launch of our groundbreaking projects including AI-Assisted Employee Audit and Smart Public Procurement System.',
      type: 'Conference',
      icon: Award,
    ...
    },
    {
      ...
      description: 'Intensive hands-on workshop covering data visualization, predictive analytics, and business intelligence tools.',
      type: 'Workshop',
      icon: TrendingUp,
    ...
    },
    {
      ...
      location: 'Virtual',
      description: 'Learn modern web development with React, Node.js, and cloud deployment strategies.',
      type: 'Workshop',
      icon: Code,
    ...
    },
    {
      ...
      description: 'Comprehensive training on threat detection, ethical hacking, and security best practices.',
      type: 'Workshop',
      icon: Shield,
    ...
    },
    {
      ...
      time: '10:00 AM - 4:00 PM',
      location: 'A4IR Headquarters, Ibadan',
      description: 'Master networking fundamentals, cloud networking, and infrastructure design.',
      type: 'Workshop',
      icon: Wifi,
                  ...
                  <div className="md:w-2/3 p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center">
                        ...
                        <span className="text-accent font-semibold">{event.type}</span>
                      </div>
